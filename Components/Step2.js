...
export class Signup extends Component {
  ...
  constructor(props) {
    ...
    this.state = { age: '', stnum: '', hnum: '', cnum: 'Madina-Town' };
  ...
  signgo = async () => {
    ...
    if (age == '' || stnum == '' || hnum == '' || cnum == ''){
      alert('Required fields are Missing');
    }
    else{
      await AsyncStorage.setItem('age1', age);
      await AsyncStorage.setItem('stnum1', stnum);
      await AsyncStorage.setItem('hnum1', hnum);
      await AsyncStorage.setItem('cnum1', cnum);
...
{/*         <View
          ...
          > 
            ...
            {/*<TouchableOpacity onPress={() => this.props.navigation.navigate('Step3')} style={styles.button1}>*/}
